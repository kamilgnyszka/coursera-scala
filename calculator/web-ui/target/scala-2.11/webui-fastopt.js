...
$c_Lcalculator_Calculator$.prototype.evalRec$1__p1__Lcalculator_Expr__sci_Set__sci_Map__D = (function(expr, forb, references$1) {
  _evalRec: while (true) {
    var x1 = expr;
    if ($is_Lcalculator_Literal(x1)) {
      ...
      var n = x3.name$2;
      if ((!forb.contains__O__Z(n))) {
        var temp$expr = this.getReferenceExpr__p1__T__sci_Map__Lcalculator_Expr(n, references$1);
        var temp$forb = $as_sci_Set(forb.$$plus__O__sc_Set(n));
        expr = temp$expr;
        forb = temp$forb;
        continue _evalRec
      } else {
      ...
      var a = x4.a$2;
      var b = x4.b$2;
      return (this.evalRec$1__p1__Lcalculator_Expr__sci_Set__sci_Map__D(a, forb, references$1) + this.evalRec$1__p1__Lcalculator_Expr__sci_Set__sci_Map__D(b, forb, references$1))
    } else if ($is_Lcalculator_Minus(x1)) {
      var x5 = $as_Lcalculator_Minus(x1);
      var a$2 = x5.a$2;
      var b$2 = x5.b$2;
      return (this.evalRec$1__p1__Lcalculator_Expr__sci_Set__sci_Map__D(a$2, forb, references$1) - this.evalRec$1__p1__Lcalculator_Expr__sci_Set__sci_Map__D(b$2, forb, references$1))
    } else if ($is_Lcalculator_Times(x1)) {
      var x6 = $as_Lcalculator_Times(x1);
      var a$3 = x6.a$2;
      var b$3 = x6.b$2;
      return (this.evalRec$1__p1__Lcalculator_Expr__sci_Set__sci_Map__D(a$3, forb, references$1) * this.evalRec$1__p1__Lcalculator_Expr__sci_Set__sci_Map__D(b$3, forb, references$1))
    } else if ($is_Lcalculator_Divide(x1)) {
      var x7 = $as_Lcalculator_Divide(x1);
      var a$4 = x7.a$2;
      var b$4 = x7.b$2;
      return (this.evalRec$1__p1__Lcalculator_Expr__sci_Set__sci_Map__D(a$4, forb, references$1) / this.evalRec$1__p1__Lcalculator_Expr__sci_Set__sci_Map__D(b$4, forb, references$1))
    } else {
...
$c_Lcalculator_Calculator$.prototype.eval__Lcalculator_Expr__sci_Map__D = (function(expr, references) {
  return this.evalRec$1__p1__Lcalculator_Expr__sci_Set__sci_Map__D(expr, $as_sci_Set($m_s_Predef$().Set$2.apply__sc_Seq__sc_GenTraversable($m_sci_Nil$())), references)
});
...
$c_Lcalculator_Polynomial$.prototype.computeSolutions__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal = (function(a, b, c, delta) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(a$2, b$2, c$2, delta$1) {
    return (function() {
      ...
      var array = [((bv + $uD($g["Math"]["pow"](dv, 0.5))) / (2.0 * av)), ((bv - $uD($g["Math"]["pow"](dv, 0.5))) / (2.0 * av))];
...
$c_Lcalculator_Polynomial$.prototype.computeDelta__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal = (function(a, b, c) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(a$1, b$1, c$1) {
    return (function() {
      ...
      return ($uD($g["Math"]["pow"](bv, 2.0)) - ((4.0 * av) * cv))
    })
  })(a, b, c));
  return new $c_Lcalculator_Signal().init___F0(expr)
});
...
$c_Lcalculator_TweetLength$.prototype.tweetRemainingCharsCount__Lcalculator_Signal__Lcalculator_Signal = (function(tweetText) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(tweetText$1) {
    return (function() {
      var t = $as_T(tweetText$1.apply__O());
      return ((140 - $m_Lcalculator_TweetLength$().calculator$TweetLength$$tweetLength__T__I(t)) | 0)
    })
  })(tweetText));
  return new $c_Lcalculator_Signal().init___F0(expr)
});
$c_Lcalculator_TweetLength$.prototype.colorForRemainingCharsCount__Lcalculator_Signal__Lcalculator_Signal = (function(remainingCharsCount) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(remainingCharsCount$1) {
    return (function() {
      var chars = $uI(remainingCharsCount$1.apply__O());
      return ((chars >= 15) ? "green" : ((chars >= 0) ? "orange" : "red"))
    })
  })(remainingCharsCount));
  return new $c_Lcalculator_Signal().init___F0(expr)
});
...
$c_Lcalculator_Calculator$$anonfun$computeValues$1.prototype.apply__T2__T2 = (function(e) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(arg$outer, e$1) {
    return (function() {
      return $m_Lcalculator_Calculator$().eval__Lcalculator_Expr__sci_Map__D($as_Lcalculator_Expr($as_Lcalculator_Signal(e$1.$$und2$f).apply__O()), $as_sci_Map(arg$outer.namedExpressions$1$f.$$minus__O__sc_Map(e$1.$$und1$f)))
    })
  })(this, e));
